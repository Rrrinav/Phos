...
inline bool is_callable(const Value &value) { return std::holds_alternative<std::shared_ptr<Function_value>>(value) || std::holds_alternative<std::shared_ptr<Closure_value>>(value); }
