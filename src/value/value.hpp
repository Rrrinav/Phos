...
using Value = std::variant<
    ...
    bool,
    std::string,
    std::shared_ptr<struct Model_value>,
    std::shared_ptr<struct Function_value>,
    std::shared_ptr<struct Closure_value>,
    std::shared_ptr<struct Array_value>,
    std::shared_ptr<struct Native_function_value>,
    std::nullptr_t, // nil
    std::monostate  // void
>;
...
struct Function_value
{
    ...
    std::shared_ptr<struct Environment> definition_environment;
