...
public:
    ...
    std::unordered_map<std::string, types::Function_data> functions;
    std::unordered_map<std::string, types::Model_data> model_data;
    std::unordered_map<std::string, types::Union_data> union_data;
    std::unordered_map<std::string, types::Enum_data> enum_data;
    ...
    const types::Function_data *get_function(const std::string &name) const;

    // Query API: Models
    bool is_model_defined(const std::string &name) const;
    const types::Model_data *get_model(const std::string &name) const;
    const types::Function_data *get_model_method(const std::string &model_name, const std::string &method_name) const;
    const types::Function_data *get_model_static_method(const std::string &model_name, const std::string &method_name) const;
    ...
    const phos::Union_data *get_union(const std::string &name) const;
    ...
    const types::Enum_data *get_enum(const std::string &name) const;
