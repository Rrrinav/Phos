...
public:
    ...
    std::unordered_map<std::string, std::string> native_types;
    ...
    void define_native_const(const std::string &name, Value val, const std::string &type_str);
    ...
    std::optional<std::string> get_native_type_str(const std::string &name) const;
